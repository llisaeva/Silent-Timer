...
public class ListItemSilentIntervalBindingImpl extends ListItemSilentIntervalBinding  {
    ...
    public ListItemSilentIntervalBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ListItemSilentIntervalBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x15L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.alarmDate, viewModelListItemDisplayDate);
        }
        if ((dirtyFlags & 0x13L) != 0) {
            // api target 1
