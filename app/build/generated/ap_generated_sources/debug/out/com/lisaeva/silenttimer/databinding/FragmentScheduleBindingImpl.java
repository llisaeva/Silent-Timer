...
public class FragmentScheduleBindingImpl extends FragmentScheduleBinding implements com.lisaeva.silenttimer.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener checkboxShowDescriptionandroidCheckedAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.showDescription
            //         is viewModel.setShowDescription((boolean) callbackArg_0)
            boolean callbackArg_0 = checkboxShowDescription.isChecked();
            // localize variables for thread safety
    ...
    private FragmentScheduleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.checkboxShowDescription.setTag(null);
        ...
        setRootTag(root);
        // listeners
        mCallback6 = new com.lisaeva.silenttimer.generated.callback.OnClickListener(this, 1);
        mCallback7 = new com.lisaeva.silenttimer.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.lisaeva.silenttimer.ui.ScheduleFragment) variable);
        }
    ...
    public void setHandler(@Nullable com.lisaeva.silenttimer.ui.ScheduleFragment Handler) {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelFriday = false;
        boolean viewModelTuesday = false;
        com.lisaeva.silenttimer.ui.ScheduleFragment handler = mHandler;
        boolean viewModelSunday = false;
        int viewModelRepeatViewVISIBLEViewGONE = 0;
        com.lisaeva.silenttimer.viewmodel.SilentIntervalViewModel viewModel = mViewModel;

        if ((dirtyFlags & 0x1fffdL) != 0) {


            if ((dirtyFlags & 0x10011L) != 0) {
        ...
        if ((dirtyFlags & 0x10000L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setListeners(this.checkboxShowDescription, (android.widget.CompoundButton.OnCheckedChangeListener)null, checkboxShowDescriptionandroidCheckedAttrChanged);
            ...
            this.endDateLabel.setOnClickListener(mCallback7);
            ...
            this.startDateLabel.setOnClickListener(mCallback6);
        }
        if ((dirtyFlags & 0x10081L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x12001L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.checkboxShowDescription, viewModelShowDescription);
    ...
    /* flag mapping
        ...
        flag 3 (0x4L): viewModel.startDate
        flag 4 (0x5L): viewModel.endDate
        flag 5 (0x6L): viewModel.repeat
        flag 6 (0x7L): viewModel.sunday
        flag 7 (0x8L): viewModel.monday
        flag 8 (0x9L): viewModel.tuesday
        flag 9 (0xaL): viewModel.wednesday
        flag 10 (0xbL): viewModel.thursday
        flag 11 (0xcL): viewModel.friday
        flag 12 (0xdL): viewModel.saturday
        flag 13 (0xeL): viewModel.showDescription
        flag 14 (0xfL): viewModel.description
        flag 15 (0x10L): viewModel.duration
        flag 16 (0x11L): null
        flag 17 (0x12L): viewModel.showDescription ? View.VISIBLE : View.GONE
        flag 18 (0x13L): viewModel.showDescription ? View.VISIBLE : View.GONE
        flag 19 (0x14L): viewModel.repeat ? View.VISIBLE : View.GONE
